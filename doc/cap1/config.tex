...
%
\defAuthor[M]{Justin Jaffeth Corea Masís}                % Nombre del estudiante
...
\defTitle{Sistema en dos etapas\\
  para la detección y reconocimiento de placas vehiculares \\%
  usando modelos extremo a extremo y datos sintéticos}

%% Palabras clave
\defKeywords{ANPR, extremo a extremo, YOLOv11, IPLMS, Sintético}
...
%%  [F]emenino,
%%  persona [N]o binaria
\defLectorI[M]{Ing.\,Javier Mauricio Pérez Rodríguez, M.Sc}
\defLectorII[M]{Dr.\,Sergio Alberto Arriola Valverde} 
